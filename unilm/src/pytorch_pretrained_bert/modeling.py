...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, input_embeds=None, token_type_ids=None, position_ids=None, task_idx=None):
        ...
        # print(f"word{words_embeddings.shape}poistion{position_embeddings.shape}token{token_type_embeddings.shape}")
...
class BertModel(PreTrainedBertModel):
    ...
    def get_extended_attention_mask(self, input_ids=None, attention_mask=None, input_embeds=None):
    ...
    def forward(self, input_ids=None, input_embeds=None, token_type_ids=None, attention_mask=None,
                output_all_encoded_layers=True, mask_qkv=None, task_idx=None):
        if input_ids is None and input_embeds is None:
            raise ValueError("input_ids and input_embeds could not be None at the same time")
        embedding_output = self.embeddings(
            input_ids=input_ids, input_embeds=input_embeds, token_type_ids=token_type_ids, task_idx=task_idx)
        extended_attention_mask = self.get_extended_attention_mask(
            input_ids, attention_mask=attention_mask, input_embeds=input_embeds)
...
class BertForSeq2SeqDecoder(PreTrainedBertModel):
    ...
    def __init__(self, config, mask_word_id=0, num_labels=2, num_rel=0,
                 ...
                 forbid_duplicate_ngrams=False, forbid_ignore_set=None, not_predict_set=None, ngram_size=3, min_len=0,
...
class BertForMaskedLM(PreTrainedBertModel):
    ...
    def forward(self, input_ids, input_embeds=None, token_type_ids=None, attention_mask=None, masked_lm_labels=None,
                mask_qkv=None, task_idx=None):
        sequence_output, _ = self.bert(input_ids, input_embeds=input_embeds, token_type_ids=token_type_ids,
